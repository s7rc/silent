...
class TouchControllerSettingsManager(private val sharedPreferences: SharedPreferences) {
    ...
    suspend fun resetSettings(
        ...
        // If settings is provided (explicit reset), update cache. Or if null (full reset)
        // Original code had no arg, but usage might expect it or not?
        // Original code: resetSettings(id, orient)
        // I will keep original signature match.
    ...
    // Helper overload if needed by interface? No, class is concrete.
